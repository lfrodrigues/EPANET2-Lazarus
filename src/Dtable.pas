...
uses
  ...
  StdCtrls, checklst, ComCtrls, Uutils, Uglobals, ExtCtrls, LResources;
...
type
  ...
  TTableOptionsForm = class(TForm)
    ...
    procedure NetNodesBtnChange(Sender: TObject);
...
procedure TTableOptionsForm.NetNodesBtnChange(Sender: TObject);
begin
