...
uses LCLIntf, LCLType, Types, Graphics, SysUtils, Dialogs, Forms, Classes,
...
begin
    ...
    ValidPicture := FileExists(FullName);
...
var
  ...
  Dx, Dy   : Extended;
begin
  //TODO: bug in lazarus: reports wrong client[width|height] when minimized
  if (Window.Pwidth = 0) or (Window.Pheight = 0) then Exit;
