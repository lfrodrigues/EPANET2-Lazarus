...
uses
  LCLIntf, LCLType, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
   ExtCtrls, Clipbrd, Xprinter, Umap, Uglobals, Uutils, LResources, MyMetafile;
...
begin
  ...
  aBitmap.Canvas.CopyRect(tmpR, MapForm.Canvas, tmpR);
  try
...
//---------------------------------------------
// Copies contour map in enhanced metafile
// format to either file or clipboard.
//---------------------------------------------
var
...
procedure TContourForm.DrawToMetafile(aMetafile: TLRMetafile);
//---------------------------------------------------------
