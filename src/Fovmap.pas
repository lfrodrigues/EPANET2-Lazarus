...
uses
  SysUtils, LCLIntf, Classes, Graphics, Controls,
  Forms, Dialogs, ExtCtrls, Uglobals, Umap, Uutils, LResources;
...
begin
  ...
  Constraints.MinHeight := MINMAPSIZE;
  Constraints.MinWidth := MINMAPSIZE;
end;
...
var
  ...
  L,T,R,B: Integer;
begin
  if MapForm = nil then Exit; //if not created yed give up
